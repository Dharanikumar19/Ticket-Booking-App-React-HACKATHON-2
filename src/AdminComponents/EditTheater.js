...
function EditTheater() {
    ...
    useEffect(async () => {
        try {
            let userData = await axios.get(`https://ticket-booking-app-nodejs.herokuapp.com/theaters/${params.id}`)
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            delete values._id;
            try {
                await axios.put(`https://ticket-booking-app-nodejs.herokuapp.com/theaters/${params.id}`,values)
